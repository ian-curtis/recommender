...
This project was my submission to the Grand Valley State University Honors College senior project under mentor Dr. Erin Carrier. All code in the [GitHub repository](https://github.com/ian-curtis/recommender) is licensed under an [MIT license](https://github.com/ian-curtis/recommender/blob/main/LICENSE).
...
library(magick)
library(cowplot)
fig_svg<-cowplot::ggdraw()+cowplot::draw_image("recommender_groups.svg")
plot(fig_svg)
```
...
[2] Novikov, A., 2019. PyClustering: Data Mining Library. Journal of Open Source Software, 4(36), p.1230. Available at: [http://dx.doi.org/10.21105/joss.01230](http://dx.doi.org/10.21105/joss.01230).
